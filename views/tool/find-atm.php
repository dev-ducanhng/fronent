    ...
    $(document).ready(function() {
        ...
        $('.btn_see_more').click(function() {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    var rendered = '';
                    $.each(jsonData['data_atm'], function(key, val) {
        ...
        $('#btn_submit').on('click', function(e) {
            ...
            if (company == '') {
                ...
                if (province == '') {
                    var URL = encodeURI("cong-cu/tim-atm/" + company_name + '-' + company) + '.html';
                } else {
                    if (district == '') {
                        var URL = encodeURI("cong-cu/tim-atm/" + company_name + '-' + province_name + '-' + company + '-' + province) + '.html';
                    } else {
                        var URL = encodeURI("cong-cu/tim-atm/" + company_name + '-' + district_name + '-' + province_name + '-' + company + '-' + province + '-' + district + ".html");
                    }
                }
            }
            if (company == '' && province != '') {
                $('.simply-toast').fadeOut();
                $.simplyToast('warning', "Bạn muốn tìm ATM của Ngân hàng nào?");
            } else if (company == '' && province == '') {
                $('.simply-toast').fadeOut();
                $.simplyToast('warning', "Bạn muốn tìm ATM của Ngân hàng, Tỉnh/Thành Phố nào?");
            } else {
...
<div class="container">
    <div class="breadcrumbs">
        ...
        <?php if (!empty($_GET['company']) & empty($_GET['province'])) : ?>
            <a href="/cong-cu/tim-atm.html" class="span_pc">Tìm ATM</a>
            <a href="/cong-cu/tim-atm.html" class="span_mobile">Tìm ATM</a>
            <i class="span_pc"></i>
            <span class="span_pc"><?= $array_company[$_GET['company']] ?></span>
            <!-- <span class="span_mobile"><?= $array_company[$_GET['company']] ?></span> -->
        <?php elseif (!empty($_GET['company']) & !empty($_GET['province']) & empty($_GET['district'])) : ?>
            <a href="/cong-cu/tim-atm.html" class="span_pc">Tìm ATM</a>
            <a href="/cong-cu/tim-atm.html" class="span_mobile">Tìm ATM</a>
            <i class="span_pc"></i>
            <a href="/cong-cu/tim-atm/<?= $this->context->actionSlug($array_company[$_GET['company']]) ?>-<?= $_GET['company'] ?>.html" class="span_pc"><?= $array_company[$_GET['company']] ?></a>
            <!-- <a href="/cong-cu/tim-atm/<?= $this->context->actionSlug($array_company[$_GET['company']]) ?>-<?= $_GET['company'] ?>.html" class="span_mobile"><?= $array_company[$_GET['company']] ?></a> -->
            <i class="span_pc"></i>
            <span class="span_pc"><?= $array_province[$_GET['province']] ?></span>
            <!-- <span class="span_mobile"><?= $array_province[$_GET['province']] ?></span> -->
        <?php elseif (!empty($_GET['company']) & !empty($_GET['province']) & !empty($_GET['district'])) : ?>
            <a href="/cong-cu/tim-atm.html" class="span_pc">Tìm ATM</a>
            <a href="/cong-cu/tim-atm.html" class="span_mobile">Tìm ATM</a>
            <i class="span_pc"></i>
            ...
            <!-- <a href="/cong-cu/tim-atm/<?= $this->context->actionSlug($array_company[$_GET['company']]) ?>-<?= $_GET['company'] ?>.html" class="span_mobile"><?= $array_company[$_GET['company']] ?></a> -->
            <i class="span_pc"></i>
            <a href="/cong-cu/tim-atm/<?= $this->context->actionSlug($array_company[$_GET['company']]) ?>-<?= $this->context->actionSlug($array_province[$_GET['province']]) ?>-<?= $_GET['company'] ?>-<?= $_GET['province'] ?>.html" class="span_pc"><?= $array_province[$_GET['province']] ?></a>
            <!-- <a href="/cong-cu/tim-atm/<?= $this->context->actionSlug($array_company[$_GET['company']]) ?>-<?= $this->context->actionSlug($array_province[$_GET['province']]) ?>-<?= $_GET['company'] ?>-<?= $_GET['province'] ?>.html" class="span_mobile"><?= $array_province[$_GET['province']] ?></a> -->
            <i class="span_pc"></i>
            <span class="span_pc"><?= $array_district[$_GET['district']] ?></span>
            <!-- <span class="span_mobile"><?= $array_district[$_GET['district']] ?></span> -->
        <?php else : ?>
            <span class="span_pc">Tìm ATM</span>
            <span class="span_mobile">Tìm ATM</span>
        <?php endif; ?>
    </div>
    <div class="filter">
        <div class="title">
            <?php if (!empty($_GET['company']) & empty($_GET['province'])) : ?>
                <h1>ĐIỂM ĐẶT CÂY ATM NGÂN HÀNG <?= mb_strtoupper($array_company[$_GET['company']], 'UTF-8') ?> TRÊN TOÀN QUỐC</h1>
            <?php elseif (!empty($_GET['company']) & !empty($_GET['province']) & empty($_GET['district'])) : ?>
                <h1>ĐIỂM ĐẶT CÂY ATM <?= mb_strtoupper($array_company[$_GET['company']], 'UTF-8') ?> TẠI <?= mb_strtoupper($array_province[$_GET['province']], 'UTF-8') ?></h1>
            <?php elseif (!empty($_GET['company']) & !empty($_GET['province']) & !empty($_GET['district'])) : ?>
                <h1>ĐIỂM ĐẶT CÂY ATM <?= mb_strtoupper($array_company[$_GET['company']], 'UTF-8') ?> TẠI <?= mb_strtoupper($array_district[$_GET['district']], 'UTF-8') ?> - <?= mb_strtoupper($array_province[$_GET['province']], 'UTF-8') ?></h1>
            <?php else : ?>
                <h1>ĐIỂM ĐẶT CÂY ATM CÁC NGÂN HÀNG TRÊN TOÀN QUỐC</h1>
            <?php endif; ?>
        </div>
        <div class="description">
            <?php if (!empty($_GET['company']) & empty($_GET['province'])) : ?>
                <h2>Công cụ giúp bạn tìm vị trí cây ATM <a href="https://thebank.vn/ngan-hang-<?= $this->context->actionSlug($array_company[$_GET['company']]) ?>-<?= $_GET['company'] ?>.html"><?= $array_company[$_GET['company']] ?></a> gần nhất một cách nhanh nhất với hướng dẫn chỉ đường ngắn nhất.</h2>
            <?php elseif (!empty($_GET['company']) & !empty($_GET['province']) & empty($_GET['district'])) : ?>
                <h2>Cập nhật danh sách địa chỉ mạng lưới và điểm đặt cây ATM <a href="https://thebank.vn/ngan-hang-<?= $this->context->actionSlug($array_company[$_GET['company']]) ?>-<?= $_GET['company'] ?>.html"><?= $array_company[$_GET['company']] ?></a> gần nhất tại <?= $array_province[$_GET['province']] ?>, giúp bạn tiết kiệm tối đa thời gian di chuyển.</h2>
            <?php elseif (!empty($_GET['company']) & !empty($_GET['province']) & !empty($_GET['district'])) : ?>
                <h2>Cập nhật danh sách địa chỉ mạng lưới và điểm đặt cây ATM <a href="https://thebank.vn/ngan-hang-<?= $this->context->actionSlug($array_company[$_GET['company']]) ?>-<?= $_GET['company'] ?>.html"><?= $array_company[$_GET['company']] ?></a> gần nhất tại <?= $array_district[$_GET['district']] ?> - <?= $array_province[$_GET['province']] ?>, giúp bạn tiết kiệm tối đa thời gian di chuyển.</h2>
            <?php else : ?>
                <h2>Công cụ giúp bạn tìm vị trí cây ATM gần nhất một cách nhanh nhất với hướng dẫn chỉ đường ngắn nhất.</h2>
            <?php endif; ?>
            ...
            <div class="left_content <?php if (empty($_GET['district'])) echo "col-12 col-lg-8" ?>" style="padding-left: 15px;padding-right: 15px;width: 100%;">
                <?php if (!empty($_GET['company']) & empty($_GET['province'])) : ?>
                    <div id="template_data_province">
                        <div class="title_province">CÂY ATM <?= mb_strtoupper($array_company[$_GET['company']], 'UTF-8') ?> CÁC TỈNH THÀNH</div>
                        <?php if ($count_company >= 4) : ?>
                            <h4>Ngân hàng <?= $array_company_long_name[$_GET['company']] ?> có mạng lưới cây ATM rộng khắp trên cả nước. Hiện nay, Ngân hàng <?= $array_company_long_name[$_GET['company']] ?> có tổng cộng hơn <?= $total_atm ?> cây ATM đặt tại <?= $count_company ?> tỉnh, thành phố trong cả nước. Trong đó nhiều nhất phải kể đến <?= $data_province[0]['province_name'] ?> - <?= $data_province[0]['count'] ?> cây ATM, <?= $data_province[1]['province_name'] ?> - <?= $data_province[1]['count'] ?> cây ATM, <?= $data_province[2]['province_name'] ?> - <?= $data_province[2]['count'] ?> cây ATM, ... và nhiều tỉnh, thành phố khác.</h4>
                ...
                <?php elseif (!empty($_GET['company']) & !empty($_GET['province']) & empty($_GET['district'])) : ?>
                    <div id="template_data_district">
                        <div class="title_province">CÂY ATM <?= mb_strtoupper($array_company[$_GET['company']], 'UTF-8') ?> TẠI <?= mb_strtoupper($array_province[$_GET['province']], 'UTF-8') ?></div>
                        <?php if ($count_province >= 4) : ?>
                            <h4>Ngân hàng <?= $array_company_long_name[$_GET['company']] ?> có mạng lưới cây ATM rộng khắp trên cả nước. Hiện nay, Ngân hàng <?= $array_company_long_name[$_GET['company']] ?> có tổng cộng hơn <?= $total_atm_by_company_province ?> cây ATM đặt tại <?= $array_province[$_GET['province']] ?>. Trong đó nhiều nhất phải kể đến <?= $data_district[0]['district_name'] ?> - <?= $data_district[0]['count'] ?> cây ATM, <?= $data_district[1]['district_name'] ?> - <?= $data_district[1]['count'] ?> cây ATM, <?= $data_district[2]['district_name'] ?> - <?= $data_district[2]['count'] ?> cây ATM, ... và nhiều quận, huyện khác.</h4>
                ...
                <?php elseif (!empty($_GET['company']) & !empty($_GET['province']) & !empty($_GET['district'])) : ?>
                    <div class="list_atm" <?php if ($count_record == 1) echo "style='padding-bottom:80px;'";
                        ...
                        <table class="table">
                            <thead class="list_atm_thead_atm">
                                <tr class="roboto">
                                    <th>#</th>
                                    <th>Điểm đặt máy ATM</th>
                                    <th>Địa chỉ</th>
                                    <th>Thời gian mở cửa</th>
                                    <th class="arrow_box">Chỉ đường</th>
                                </tr>
                            </thead>
                            <tbody class="content_branch_atm roboto-light">
                                <?php foreach ($data_companies as $item) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <p class="text_mobile">
                                                Đ/C: <?= $item['address'] ?><br>
                                                Thời gian hoạt động: <?= $item['open_time'] ?><br>
                                            </p>
                                        </td>
                                        <td>
                                            <?= $item['address'] ?>
                ...
                <div class="right_content col-12 col-lg-4">
                    <div class="right_btn">
                        ...
                        <?php if (!empty($_GET['company']) & empty($_GET['province'])) : ?>
                            ...
                            <a href="../tim-chi-nhanh-ngan-hang/<?= $this->context->actionSlug($array_company[$_GET['company']]) ?>-<?= $_GET['company'] ?>.html" class="btn_5" target="_blank">Chi nhánh NH <?= $array_company[$_GET['company']] ?> gần nhất</a>
                        <?php elseif (!empty($_GET['company']) & !empty($_GET['province'])) : ?>
                            <a href="https://thebank.vn/ngan-hang-<?= $this->context->actionSlug($array_company[$_GET['company']]) ?>-<?= $_GET['company'] ?>.html" class="btn_2" target="_blank">Thông tin ngân hàng <?= $array_company[$_GET['company']] ?></a>
                            <a href="https://thebank.vn/gui-tiet-kiem/gui-tiet-kiem-ngan-hang-<?= $this->context->actionSlug($array_company[$_GET['company']]) ?>-<?= isset($array_gtk[$_GET['company']]) ? $array_gtk[$_GET['company']] : '' ?>.html" class="btn_3" target="_blank">Lãi suất ngân hàng <?= $array_company[$_GET['company']] ?></a>
                            <a href="https://thebank.vn/cong-cu/tinh-ty-gia-ngoai-te/ty-gia-<?= $array_slug_company[$_GET['company']] ?>.html" class="btn_4" target="_blank">Tỷ giá ngân hàng <?= $array_company[$_GET['company']] ?></a>
                            <a href="../tim-chi-nhanh-ngan-hang/<?= $this->context->actionSlug($array_company[$_GET['company']]) ?>-<?= $this->context->actionSlug($array_province[$_GET['province']]) ?>-<?= $_GET['company'] ?>-<?= $_GET['province'] ?>.html" class="btn_5" target="_blank">Chi nhánh NH <?= $array_company[$_GET['company']] ?> gần nhất</a>
                        <?php else : ?>
                            ...
                            <a href="tim-chi-nhanh-ngan-hang.html" class="btn_5" target="_blank">Chi nhánh ngân hàng</a>
                        <?php endif; ?>
                        <div class="banner">
                ...
                <div class="maybe_yk">
                    ...
                    <div class="list_maybe_yk">
                        <?php foreach ($arr_most_view_company as $item) : ?>
                            ...
                            <?php else : ?>
                                <a href="/cong-cu/tim-atm/<?= $this->context->actionSlug($array_company[$item['id']]) ?>-<?= $item['id'] ?>.html" target="_blank">ATM <?= $item['short_name'] ?></a>
                            <?php endif; ?>
                        <?php endforeach; ?>
                    </div>
                </div>
